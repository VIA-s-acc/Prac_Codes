...
2.  `plot_solution(self, u, T, L, N, M, **kwargs)`:
    - Plot the solution for EPV

#### Non Class help functions in Plotter module
use with `MPE.plotter.plot`, not with `plotter.plot_solution`
1.  `return_error(func)`:
